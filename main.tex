...
% Future Scope 
% What are some key learnings throught this excercise ? 
% That even thought algorithm is fully open source, no one can break it .

\begin{thebibliography}{9}
\bibitem{ALM}
\href{https://indiaevm.org/evm_tr2010-jul29.pdf}{Security Analysis of India’s Electronic Voting Machines} - Hari K. Prasad, J. Alex Halderman, Rop Gonggrijp% \bibitem{BL}
